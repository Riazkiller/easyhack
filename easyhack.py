...
echo -e $o"$green               Made by$yellow RIAZKHAN "$o
...
CREDITS GOES TO$g SABRi$yellow"@"$green"RIAZ"$yellow from $g"Alpha"$r"Team"$w"DZ"$r (o_O)$reset"
echo
...
echo -n "[EasY_HaCk]~#:"
read tmp4
echo -e "$w My Facebook ID> $yellow https://www.facebook.com/Riaz-hacker-100835532473815/"
